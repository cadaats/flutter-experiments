...
class FabDial extends FloatingActionButton {
...
class FabDialer extends StatefulWidget {
  ...
  final List<FabDial> childButtons;
  ...
  _FabDialer createState() => _FabDialer();
}

class _FabDialer extends State<FabDialer> with TickerProviderStateMixin {
